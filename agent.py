...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        #elif self.Q[state][self.next_waypoint] > 0:
        #    return self.next_waypoint

        #elif self.get_maxQ(state) < 0:
        #    return None
            else:
        #        acts = []
                acts = [act for act,val in self.Q[state].items() if val == maxQ]
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, alpha = 0.7,epsilon = 0.99)
